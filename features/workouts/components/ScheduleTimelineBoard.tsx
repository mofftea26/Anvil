...
function DraggableItem(props: {
  ...
  const { canDrag, item, top, onPress, onDropTime, onDragPreviewHour } = props;
      ...
      >
        <VStack style={{ gap: 4 }}>
          <HStack align="center" justify="space-between">
            <View style={[styles.sourceDot, { backgroundColor: props.item.sourceColor }]} />
            <Text style={{ color: theme.colors.textMuted, fontSize: 11 }}>
              {dragPreviewTimeLabel ?? formatScheduleTimeLabel(props.item.scheduledTime)}
            </Text>
          </HStack>
...
export function ScheduleTimelineBoard(props: {
  title?: string;
  monthLabel?: string;
  monthIndex?: number;
  year?: number;
